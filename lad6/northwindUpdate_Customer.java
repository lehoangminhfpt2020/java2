...
public class northwindUpdate_Customer {
    public static void main(String[] args) {
        ...
        {
            String SQL = "Update customers set Address = '1A -Yet Kieu - Ha Noi' where CustomerID = 'FRANK'";
            System.out.println("The sql statement is: " + SQL + "\n");
            stmt.executeUpdate(SQL);
            System.out.println("Updated");
            ResultSet rSet = stmt.executeQuery("SELECT * from customers ");
            while (rSet.next()){
                System.out.println(rSet.getString("CustomerID") + ", " + rSet.getString("ContactName")+ ", " + rSet.getString("Address"));
            }
